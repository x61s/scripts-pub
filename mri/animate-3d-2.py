...
def get_sagittal_view(volume, pixel_spacing, slice_thickness):
    ...
    return resize_slices(sagittal_slices, scale_x=scale_x, scale_y=1)
...
def get_coronal_view(volume, pixel_spacing, slice_thickness):
    ...
    scale_x = pixel_spacing[0] / slice_thickness  # Adjust x-axis (columns) based on slice thickness
    return resize_slices(coronal_slices, scale_x=scale_x, scale_y=1)
...
if __name__ == "__main__":
    ...
    # Generate sagittal view (side view) with correct proportions
    ...
    # Generate coronal view (front view) with correct proportions
