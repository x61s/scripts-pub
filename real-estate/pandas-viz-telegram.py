...
P = dfTelegram.plot(ax=axWeb, kind='scatter', x='Property Size', y='Price', alpha=1.0, color='lightblue', label='Telegram public chat')

P.legend(facecolor='darkgray')

P.set_title('Prices scatter 2023-04-09 [Telegram]')
